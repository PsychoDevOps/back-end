...
/**
 *
 * <p>Controller class for psychologist.</p>
 *
 */
...
public class PsychologistController {
  ...
  @Operation(summary = "Get Psychologists by session type",
          description = "Get Psychologist by session type")
  @GetMapping("sessionType/{sessionType}")
  public List<PsychologistResource> getPsychologistsBySessionType(
  ...
  @Operation(summary = "Get Psychologists by genre and session type",
          description = "Get Psychologist by genre and session type")
  @GetMapping("genre/{genre}&sessionType/{sessionType}")
  public List<PsychologistResource> getPsychologistByGenreAndSessionType(
          @PathVariable String genre, @PathVariable String sessionType) {
  ...
  public PsychologistResource updatePsychologist(@PathVariable Long psychologistId,
                                                 @RequestBody UpdatePsychologistResource request) {
  ...
  public PsychologistSchedule createSchedule(@PathVariable Long scheduleId,
    ...
    try {
      ...
      PsychologistSchedule psychologistSchedule =
              new PsychologistSchedule(newFk, psychologist, schedule);
