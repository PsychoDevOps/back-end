...
/**
 *
 * <p>Controller class for appointment.</p>
 *
 */
...
public class AppointmentController {
  ...
  @Operation(summary = "Get all appointments by psychologistId",
          description = "Get all appointments by psychologistId")
  ...
  @Operation(summary = "Get all patients by psychologistId",
          description = "Get all patients by psychologistId")
  ...
  @Operation(summary = "Get all appointments by psychologistId and patientId",
          description = "Get all appointments by psychologistId and patientId")
  @GetMapping("/psychologist/{psychologistId}/patient/{patientId}")
  public List<AppointmentResource> getAllAppointmentsByPsychologistIdAndPatientId(
          @PathVariable Long psychologistId, @PathVariable Long patientId) {
    return mapper.toResource(appointmentService.getByPatientIdAndPsychologistId(
  ...
  public AppointmentResource createAppointment(@PathVariable(name = "patientId") Long patientId,
                                ...
                                @Valid @RequestBody CreateAppointmentResource request) {
  ...
  public AppointmentResource updateAppointment(@PathVariable Long appointmentId,
                                     @Valid @RequestBody UpdateAppointmentResource request) {
