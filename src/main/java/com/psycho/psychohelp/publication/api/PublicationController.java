...
/**
 *
 * <p>Controller class for publication.</p>
 *
 */
...
public class PublicationController {
  ...
  public PublicationResource createPublication(@PathVariable Long psychologistId,
                                         @Valid @RequestBody CreatePublicationResource request) {
  ...
  public PublicationResource updatePublication(@PathVariable Long publicationId,
                                     @Valid @RequestBody UpdatePublicationResource request) {
  ...
  @Operation(summary = "Get Publication by psychologist Id",
          description = "Get Publication by psychologist Id")
  @GetMapping("psychologist/{psychologistId}")
  public List<PublicationResource> getPublicationByPsychologistId(
